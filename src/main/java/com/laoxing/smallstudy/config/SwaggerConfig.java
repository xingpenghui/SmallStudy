...
public class SwaggerConfig {
    ...
    public ApiInfo createAI(){
        ApiInfo apiInfo=new ApiInfoBuilder().title("基于SpringBoot+Mybatis-Plus").
                description("小书屋一套后端接口").
    ...
    public Docket createD(){
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(createAI()).select().
                apis(RequestHandlerSelectors.basePackage("com.laoxing.smallstudy.controller")).build();
    }
}